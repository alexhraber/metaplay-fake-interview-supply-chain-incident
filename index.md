---
layout: default
title: "A Fake Interview, npm install, and a Staged JavaScript Payload"
description: "A defensive incident write-up on a malicious fake-interview repository using npm lifecycle execution, staged JavaScript, environment exfiltration, and C2 polling."
---

# A Fake Interview, `npm install`, and a Staged JavaScript Payload
...
- **Incident type:** Fake-interview / supply-chain / npm lifecycle execution
- **Live execution:** Root `npm i` was run during the interview
